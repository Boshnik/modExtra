...
class modExtraSortProcessor extends modObjectProcessor
{
    ...
    /**
     * @param modExtra $source
     * @param modExtra $target
     *
     * @return array|string
     */
    public function sort(modExtra $source, modExtra $target)
    {
